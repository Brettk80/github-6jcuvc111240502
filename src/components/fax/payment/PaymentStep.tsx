    ...
    try {
      ...
      toast.success(
        <div className="flex flex-col gap-1">
          <div className="font-medium">Order Successfully Placed</div>
          <div className="text-sm">
            {isTestFaxRequested 
              ? "Your test fax is being processed. You'll be notified when it's ready for review."
              : "Your fax broadcast has been queued for delivery."}
          </div>
        </div>,
        {
          duration: 5000,
